...
import '../services/API/company.dart';
...
class _AddCustomerPageState extends State<AddCustomerPage> {
                                          ...
                                          Expanded(
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                TextFormField(
                                                  controller:
                                                      _bagesNumberController,
                                                  keyboardType:
                                                      TextInputType.number,
                                                  focusNode:
                                                      _bagesNumberFocusNode,
                                                  validator: (value) => value!
                                                          .isEmpty
                                                      ? 'Veuillez entrer le nom et prénom'
                                                      : null,
                                          ...
                                          Expanded(
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                TextFormField(
                                                    controller:
                                                        _bageWeightController,
                                                    keyboardType:
                                                        TextInputType.number,
                                                    focusNode:
                                                        _bageWeightFocusNode,
                                                    cursorColor:
                                                        const Color(0xFF757575),
                                                    decoration: InputDecoration(
                                                      labelText:
  ...
  Future<void> _submitForm(String token) async {
    if (_formKey.currentState?.validate() ?? false) {
      ...
      Bags bags = Bags(weight: _bageWeight, number: _bagesNumber);
  ...
  void dispose() {
    ...
    _bagesNumberController.dispose();
    _bageWeightController.dispose();
    _containersNumberFocusNode.dispose();
